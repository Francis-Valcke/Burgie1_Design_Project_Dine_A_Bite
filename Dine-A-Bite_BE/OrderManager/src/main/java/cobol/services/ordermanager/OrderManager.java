...
public class OrderManager {
    ...
    public static void main(String[] args) {
        ...
        ACURL= localTest ? "http://localhost:8080" : "http://cobol.idlab.ugent.be:8090";
        OMURL= localTest ? "http://localhost:8081" : "http://cobol.idlab.ugent.be:8091";
        SMURL= localTest ? "http://localhost:8082" : "http://cobol.idlab.ugent.be:8092";
        ECURL= localTest ? "http://localhost:8083" : "http://cobol.idlab.ugent.be:8093";
