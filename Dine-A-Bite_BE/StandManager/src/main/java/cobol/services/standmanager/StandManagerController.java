...
public class StandManagerController {
    ...
    /**
     *
     * @param type: type of food where you want to find recommendations for
     * @return returns JSON file with best recommendations (currently based on remaining queue time only). The "amountOfRecommends" is used
     * to decide how many recommendations you want to get
     */
